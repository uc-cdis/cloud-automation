...
state_bucket_name = "terraform-state--993428853"
...
state_bucket_name_csoc = "terraform-state--426447812"
...
credential_file = "~/terraform/project-factory-15710.json"
...
folder = "test-commons-folder"

# ------------------------------------
#   Project Variables
# ------------------------------------

project_name = "test-commons-project"
region = "us-central1"
...
commons_private_subnet_ip = "172.19.0.0/24"
...
commons_private_subnet_secondary_ip1 = "10.0.0.0/20"
commons_private_subnet_secondary_ip2 = "10.0.16.0/20"
...
commons_ingress_target_tags = ["commons-private"]
...
commons_egress_target_tags = ["commons-private"]
...
network_name = "commons-private"
network_policy_config = true
node_name = "commons001-dev-gke-1-node"
node_tags = ["commons-private", "public-google", "ingress-from-csoc2-private"]
...
isql_name = "test-me-sql-7"
db_name = ["sheepdog","windmill"]
