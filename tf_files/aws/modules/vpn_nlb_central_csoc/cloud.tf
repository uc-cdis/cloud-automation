...
sudo sed -i "s/HOSTNAME/${var.env_vpn_nlb_name}/" /root/openvpn_management_scripts/templates/csoc_vpn_user_variable_templ
sudo sed -i "s/VPN_SUBNET/${var.csoc_vpn_subnet}/" /root/openvpn_management_scripts/templates/csoc_vpn_user_variable_templ
sudo sed -i "s/VM_SUBNET/${var.csoc_vm_subnet}/" /root/openvpn_management_scripts/templates/csoc_vpn_user_variable_templ
#sudo sed -i "s/VM_ROUTE_PUSH/10.128.2.0\/24/" /root/openvpn_management_scripts/templates/csoc_vpn_user_variable_templ
