...
module "squid-auto" {
  ...
  squid_proxy_subnet             = "${var.network_expansion ? cidrsubnet(var.vpc_cidr_block,7,1) : cidrsubnet(var.vpc_cidr_block,4,1)}"
  organization_name              = "${var.organization_name}"
  ssh_key_name                   = "${var.ssh_key_name}"
...
resource "aws_subnet" "public" {
  ...
  cidr_block              = "${var.network_expansion ? cidrsubnet(var.vpc_cidr_block,7,0) : cidrsubnet(var.vpc_cidr_block,4,0)}"
