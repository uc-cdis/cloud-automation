...
module "config_files" {
  ...
  db_gdcapi_address           = "${aws_db_instance.db_gdcapi[count.index].address}"
  db_gdcapi_username          = "${aws_db_instance.db_gdcapi[count.index].username}"
  ...
  db_gdcapi_name              = "${aws_db_instance.db_gdcapi[count.index].name}"
...
module "cdis_alarms" {
  ...
  db_gdcapi_size              = "${aws_db_instance.db_gdcapi[count.index].allocated_storage}"
  db_fence                    = "${aws_db_instance.db_fence[count.index].identifier}"
  db_indexd                   = "${aws_db_instance.db_indexd[count.index].identifier}"
  db_gdcapi                   = "${aws_db_instance.db_gdcapi[count.index].identifier}"
}
