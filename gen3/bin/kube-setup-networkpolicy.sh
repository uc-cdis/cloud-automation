...
if [[ -f "$credsPath" ]]; then # setup netpolicy
  ...
  g3k_kv_filter "${GEN3_HOME}/kube/services/netpolicy/networkpolicy_pelican_templ.yaml" GEN3_GDCAPIDB_IP "$GDCAPIDB_IP" GEN3_CLOUDPROXY_CIDR "$CLOUDPROXY_CIDR" | g3kubectl apply -f -
