...
#   if g3kubectl get cronjob cleanup-expired-ga4gh-info >/dev/null 2>&1; then
#       echo "cleanup-expired-ga4gh-info being added as a cronjob b/c fence >= 6.0.0 or 2022.02"
