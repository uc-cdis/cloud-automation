...
# The arn of the cert created in ACM. Should be setup for the hostname of the commons.
aws_cert_name="arn:aws:acm:REGION:ACCOUNT-NUMBER:certificate/CERT-ID"
# The account ID of the CSOC. CSOC is the Commons Services Operations Center and is a master account that should be setup before your commons. Is optional
...
# The url of the dictionary. This is only used to fill template files that can be updated later.
dictionary_url="https://s3.amazonaws.com/dictionary-artifacts/YOUR/DICTIONARY/schema.json"
# The type of portal app. Dev will set the default portal look. gitops allows you to override it in your manifest directory. This is only used to fill template files that can be updated later.
portal_app="dev"
# These correspond to snapshot names that you can use to create your instance with, in case you want to start you rds instances from snapshots
fence_snapshot=""
gdcapi_snapshot=""
peregrine_snapshot=""
sheepdog_snapshot=""
...
fence_db_instance    = "db.t3.smmall"
sheepdog_db_instance = "db.t3.smmall"
indexd_db_instance   = "db.t3.small"
# The hostname of your commons. This is only used to fill template files that can be updated later.
hostname="YOUR.API.HOSTNAME"
# ssh key to add to commons
kube_ssh_key="${kube_ssh_key}"
# A list of ssh keys to add to your commons
kube_additional_keys=""
# This indexd guid prefix should come from Trevar/ZAC
indexd_prefix=ENTER_UNIQUE_GUID_PREFIX
# The clientid/secret of your google client, for oath login. This is only used to fill template files that can be updated later.
google_client_secret="YOUR.GOOGLE.SECRET"
google_client_id="YOUR.GOOGLE.CLIENT"
# alphanumeric characters used for encryption or db connections.  This is only used to fill template files that can be updated later.
...
# The search criteria squid will use to find it's ami
squid_image_search_criteria="ubuntu/images/hvm-ssd/ubuntu-bionic-18.04-amd64-server-*"
# The vpc of the CSOC
peering_vpc_id="vpc-e2b51d99"
# The vpc endpoint of the squid in the CSOC
squid-nlb-endpointservice-name="com.amazonaws.vpce.us-east-1.vpce-svc-0ce2261f708539011"
# The location of the useryaml.Should be an S3 location. This is only used to fill template files that can be updated later.
...
mailgun_smtp_host=""
mailgun_api_url=""
# Whether to have highly available rds instances
fence_ha=false
sheepdog_ha=false
indexd_ha=false
...
# The backup window for the rds instances
...
# The default db name and master usernames of the rds instances. Should not change for typical operations.
...
# Whether to deploy the rds instances
deploy_sheepdog_db=true
deploy_fence_db=true
deploy_indexd_db=true
# Engine of rds instances. We currently only support postgres.
